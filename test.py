...
x,i,s,t = my_module.foo(X1,X2,"f64_i32",I1,I2)
print(f"x: {x.dtype} {x} | i: {i.dtype} {i} | s: {s.dtype} {s.nnz} {s} | t: {t.dtype} {t.nnz} {t}")
...
x,i,s,t = my_module.foo(X1,X2,"f64F_i32F",I1,I2)
print(f"x: {x.dtype} {x} | i: {i.dtype} {i} | s: {s.dtype} {s.nnz} {s} | t: {t.dtype} {t.nnz} {t}")
...
x,i,s,t = my_module.foo(X1,X2,"f64C_i32C",I1,I2)
print(f"x: {x.dtype} {x} | i: {i.dtype} {i} | s: {s.dtype} {s.nnz} {s} | t: {t.dtype} {t.nnz} {t}")
...
I1 = np.array([[1,2],[3,4]],dtype=np.int32)
I2 = np.array([[5,6],[7,8]],dtype=np.int32)
x,i,s,t = my_module.foo(X1,X2,"f32_i32",I1,I2)
print(f"x: {x.dtype} {x} | i: {i.dtype} {i} | s: {s.dtype} {s.nnz} {s} | t: {t.dtype} {t.nnz} {t}")
...
x,i,s,t = my_module.foo(X1,X2,"f64_i64",I1,I2)
print(f"x: {x.dtype} {x} | i: {i.dtype} {i} | s: {s.dtype} {s.nnz} {s} | t: {t.dtype} {t.nnz} {t}")
